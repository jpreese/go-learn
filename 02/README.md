...
But first.. types mean variablesand variables mean..
...
1. [Memory Layouts in Go](https://go101.org/article/memory-layout.html) - Article diving deeper into how Go lays out memory
1. [Slice usage and internals](https://blog.golang.org/go-slices-usage-and-internals) - Blog post explaining some of the more technical aspects of slices
